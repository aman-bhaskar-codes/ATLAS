...
from atlas.orchestration.types import Capabilities, Observation, Plan, PlanStep, RiskLevel
...
class Replanner:
    ...
    @staticmethod
    def _to_plan(data: dict[str, object]) -> Plan:
        """Identical to Planner._to_plan() — kept here to avoid coupling."""
        ...
        steps = tuple(
            PlanStep(
                ...
                if isinstance(s.get("expected_output"), str) else None,
            )
