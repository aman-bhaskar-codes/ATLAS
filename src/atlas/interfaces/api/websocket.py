...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, client_id: str | None = None) -> str:
        ...
        _log.info("ws.connected", event_type="websocket", client_id=cid, total_clients=len(self._active))
        return cid
    ...
    async def disconnect(self, client_id: str) -> None:
        ...
        _log.info("ws.disconnected", event_type="websocket", client_id=client_id, total_clients=len(self._active))
    ...
    async def send_personal(self, client_id: str, message: dict[str, Any]) -> bool:
        ...
        try:
            ...
            _log.warning("ws.send_failed", event_type="websocket", client_id=client_id, error=str(exc))
    ...
    async def broadcast(self, event: Event) -> None:
        ...
        for client_id, websocket in clients:
            ...
            try:
                ...
                _log.warning("ws.broadcast_failed", event_type="websocket", client_id=client_id, error=str(exc))
...
class EventBroadcaster:
    ...
    def start(self) -> None:
        ...
        _log.info("ws.broadcaster_started", event_type="websocket", subscribed_topics=topics)
    ...
    async def _broadcast_handler(self, event: Event) -> None:
        ...
        for client_id, websocket in clients:
            try:
                ...
                _log.warning("ws.memory_broadcast_failed", event_type="websocket", client_id=client_id, error=str(exc))
                dead_clients.append(client_id)
