...
class SubmitEngine:
    ...
    async def submit(
        ...
        req = ApprovalRequest(
            ...
            detail=self._render_text(preview),
            timeout_s=600.0,
        ...
        if not decision.approved:
            _log.info(
                "browser.submit_denied",
                extra={"cid": correlation_id, "url": form.action_url, "timed_out": decision.timed_out},
            )
